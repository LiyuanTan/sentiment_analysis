...
1. You will get a folder named 'npbin_movie' with 4 files in the 'numpy_to_matlab' folder.
 
#### Run amazon_validation_to_matlab.ipynb to get the validation set of implementing DELM on the Amazon review dataset
1. You will get a folder named 'npbin_amazon' with 4 files in the 'numpy_to_matlab' folder.

#### Run hotel_validation_to_matlab.ipynb to get the validation set of implementing DELM on the Hotel review dataset
1. You will get a folder named 'npbin_hotel' with 4 files in the 'numpy_to_matlab' folder.
...
1. You need to copy a file prefixed with testdata from the 'npbin_movie_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 4th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
2. You need to copy a file prefixed with testlabel from the 'npbin_movie_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 5th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
3. You need to copy a file prefixed with traindata from the 'npbin_movie_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 6th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
4. You need to copy a file prefixed with trainlabel from the 'npbin_movie_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 7th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
5. You have to adjust your own hyper parameters such as 'TotalLayers', 'HiddenNeurons', 'C1', 'RhoValue', 'Sigpara', and 'Sigpara1' in the 1st section in the 'delm.mlx' file. Details of the function are in the 'MELM_MNIST25.m' file.
6. You have to run the 1st section in the 'delm.mlx' file.
7. You need to collect all the result after running the file.
...
1. You need to copy a file prefixed with testdata from the 'npbin_amazon_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 4th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
2. You need to copy a file prefixed with testlabel from the 'npbin_amazon_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 5th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
3. You need to copy a file prefixed with traindata from the 'npbin_amazon_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 6th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
4. You need to copy a file prefixed with trainlabel from the 'npbin_amazon_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 7th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
5. You have to adjust your own hyper parameters such as 'TotalLayers', 'HiddenNeurons', 'C1', 'RhoValue', 'Sigpara', and 'Sigpara1' in the 1st section in the 'delm.mlx' file. Details of the function are in the 'MELM_MNIST25.m' file.
6. You have to run the 1st section in the 'delm.mlx' file.
7. You need to collect all the result after running the file.
8. You have to collect the training time and the testing accuracy after running the file.
...
1. You need to copy a file prefixed with testdata from the 'npbin_hotel_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 4th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
2. You need to copy a file prefixed with testlabel from the 'npbin_hotel_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 5th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
3. You need to copy a file prefixed with traindata from the 'npbin_hotel_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 6th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
4. You need to copy a file prefixed with trainlabel from the 'npbin_hotel_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 7th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
5. You have to adjust your own hyper parameters such as 'TotalLayers', 'HiddenNeurons', 'C1', 'RhoValue', 'Sigpara', and 'Sigpara1' in the 1st section in the 'delm.mlx' file. Details of the function are in the 'MELM_MNIST25.m' file.
6. You have to run the 1st section in the 'delm.mlx' file.
7. You need to collect all the result after running the file.
8. You have to collect the training time and the testing accuracy after running the file.
...
1. You need to copy a file prefixed with testdata from the 'npbin_airline_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 4th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
2. You need to copy a file prefixed with testlabel from the 'npbin_airline_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 5th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
3. You need to copy a file prefixed with traindata from the 'npbin_airline_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 6th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
4. You need to copy a file prefixed with trainlabel from the 'npbin_airline_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 7th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
5. You have to adjust your own hyper parameters such as 'TotalLayers', 'HiddenNeurons', 'C1', 'RhoValue', 'Sigpara', and 'Sigpara1' in the 1st section in the 'delm.mlx' file. Details of the function are in the 'MELM_MNIST25.m' file.
6. You have to run the 1st section in the 'delm.mlx' file.
7. You need to collect all the result after running the file.
8. You have to collect the training time and the testing accuracy after running the file.
...
1. You need to copy a file prefixed with testdata from the 'npbin_twitter_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 4th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
2. You need to copy a file prefixed with testlabel from the 'npbin_twitter_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 5th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
3. You need to copy a file prefixed with traindata from the 'npbin_twitter_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 6th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
4. You need to copy a file prefixed with trainlabel from the 'npbin_twitter_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 7th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
5. You have to adjust your own hyper parameters such as 'TotalLayers', 'HiddenNeurons', 'C1', 'RhoValue', 'Sigpara', and 'Sigpara1' in the 1st section in the 'delm.mlx' file. Details of the function are in the 'MELM_MNIST25.m' file.
6. You have to run the 1st section in the 'delm.mlx' file.
7. You need to collect all the result after running the file.
8. You have to collect the training time and the testing accuracy after running the file.
...
1. You need to copy a file prefixed with testdata from the 'npbin_reddit_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 4th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
2. You need to copy a file prefixed with testlabel from the 'npbin_reddit_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 5th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
3. You need to copy a file prefixed with traindata from the 'npbin_reddit_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 6th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
4. You need to copy a file prefixed with trainlabel from the 'npbin_reddit_test' folder to the 'npbin' folder. Then run the 3rd section in the 'delm.mlx' file. Next run the 7th section in the 'delm.mlx' file. At last delete the file in the 'npbin' folder.
5. You have to adjust your own hyper parameters such as 'TotalLayers', 'HiddenNeurons', 'C1', 'RhoValue', 'Sigpara', and 'Sigpara1' in the 1st section in the 'delm.mlx' file. Details of the function are in the 'MELM_MNIST25.m' file.
6. You have to run the 1st section in the 'delm.mlx' file.
7. You need to collect all the result after running the file.
8. You have to collect the training time and the testing accuracy after running the file.
